...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let thumbImageHighLigthed = UIImage (named: "SliderThumb-Highlighted@2x.png")
        mySliderCustom.setThumbImage(thumbImageHighLigthed, forState: .Highlighted)
        ...
        if let trackRightImage = UIImage(named: "SliderTrackRight@2x.png"){
        let trackRightRisezable = trackRightImage.resizableImageWithCapInsets(insets)
        mySliderCustom.setMaximumTrackImage(trackRightRisezable, forState: .Normal )
        }
